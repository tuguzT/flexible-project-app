...
import io.github.tuguzt.flexibleproject.view.utils.PasswordTextField
...
fun AuthScreenContent(
    ...
    Button(
        ...
        enabled = viewModel.isValidCredentials(),
        content = { Text(title) },
    )
    ...
    GoogleAuthButton(onClick = { /* todo onAuth(AuthVariant.Google) */ }, enabled = false)
}
